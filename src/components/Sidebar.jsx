export default function Sidebar({ children, isOpen, onClickClose }) {
  ...
  return (
    <div>
      <div
        className={`trnasition fixed right-0 top-0 z-50 h-full w-full overflow-y-auto bg-white p-4 duration-300 dark:bg-night md:w-[50%] lg:w-[35%] ${isOpen ? "translate-x-0" : "translate-x-full"} `}
      >
        <button
